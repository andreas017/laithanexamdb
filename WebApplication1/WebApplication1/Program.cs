...
builder.Services.AddValidatorsFromAssemblyContaining<CreateTheatreValidator>();
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(GetTheatreHandler).Assembly));
